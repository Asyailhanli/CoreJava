...
public class WrapperClass01 {
    ...
    public static void main(String[] args) {
      ...
      Byte wrapperByte = 12; //"wrapperByte" yazip nokta koydugunuzda bir cok method gorursunuz, cunku "wrapper"lar method icerir.
        ...
        // Example 1 : byte data type'nin en kucuk ve ne buyuk degerlerini ekrana yazdiriniz.
        ...
        // Example 2: short, int,long data type'larinin en buyuk ve en kucuk degerlerını ekrana yazdırınız.
