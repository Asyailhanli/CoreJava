...
public class TypeCasting01 {
    ...
    // Type Casting;Bir numeric data type'leri diger numeric data type' leri cevirmek demektir.
    ...
    // Example 1 : short'u double'a ceviren kodu giriniz
    ...
    // Example 2 : float'ı byte yapan kodu yaziniz.
        ...
        System.out.println(newNumber); // 3 ==> Java 515'i 256(byte daki sayilarin sayisi) ya kalanı return etti.
