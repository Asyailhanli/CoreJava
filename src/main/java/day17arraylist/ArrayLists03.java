...
public class ArrayLists03 {
    ...
    public static void main(String[] args) {
        ...
        Collections.sort(a);//Listeki elemanlari kucukten buyuge dizebilmek icin Collection sort kullanilir
        ...
        for(int i=1 ; i<a.size() ; i++){
            ...
            minFark=Math.min(minFark,a.get(i)-a.get(i-1));//a listinde index 1 olan 
