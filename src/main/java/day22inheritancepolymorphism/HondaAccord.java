...
public class HondaAccord extends Honda {//burada constructor var ama gorunmuyor

    /*
      1)Siz Class olsuturdugunuz da Java otomatik olarak size gorunmez bir constructor verir, cunku
      ...
      4)Bir Class'ta birden fazla constructor olabilir.Fakat bu constructor'larin parametre'leri farkli olmalidir
      ...
      6)Constructor kullanarak variable'lar uzerinde yaptigimiz degisimler sadece Object uzerindeki variable'larin degelerini degistirir.
    ...
    public HondaAccord(){// gorunmeyen constructor'i gorunur hale getirdik
