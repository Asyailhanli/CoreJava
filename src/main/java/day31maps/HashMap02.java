...
public class HashMap02 {
    /*INTERVIEW!!!!!
       ...
       3)Yerlestirirken 4'lu bir yapi olusturur, bu yapinin ilk bolumune "HashCode"u, ikinci bolumune "Key"i, ucuncu bolumune "Value" u ve dorduncu bolumune
         "pointer"i koyar. Bu cok bolumlu yapi LinkedList'lerdeki "Node"dur.Yani HashMap bucket'leri koydugu data'yi LinkedList olarak depolar
       ...
       5)Java normalde HashCode'leri unique yapar ama bazen trafik kazasi gibi farkli iki eleman icin
         ayni HashCode uretebilir. Buna "Hash Collision: denir. Hash Collision meshur bir
         Java Development problemidir.Bu problem karsilasildiginda developer'lar  bu problemi cozmek icinn kodlar yazarlar,ama bu
