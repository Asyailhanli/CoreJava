...
public class TreeMap01 {
    ...
    /*
        ...
        3)TreeMap'ler tread-safe ve synchronized degildir.
     */
    ...
    public static void main(String[] args) {
        ...
        //tailMap() verilen key'den baslayarak sona kadar tum entry'leri size veriyor
        ...
        NavigableMap< String, Double> map2=salaries.tailMap("Kevin Bridgeman",false);//kevin bridgeman disinda olani yaz
        ...
        //lowerEntry("mary star) mary star'in bor oncekini verir
        Map.Entry<String, Double> map4=salaries.lowerEntry("Mary Star");//lower bir oncekini verir
        ...
        //ceilingEntry() var olan ile kullanilirsa o key'i verir var olmayan bir key ile kullanilirsa bir sonrakini verir
