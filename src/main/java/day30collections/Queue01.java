...
public class Queue01 {
    /*
      Ilk giren elemani ilk kullanmaniz(fist in first out===>FIFO) gerektiginde Queue en iyi secer.
      Queue da elemanlae"insertion order" a gore dizilirler.
      Queue da peek(),element(),remove() gibi ilk elemani ilgilendiren bir cok method vardir.
