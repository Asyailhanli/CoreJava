...
public class MultiDimensionalArrays01 {
    ...
    //Bir Array'in elemanlari Array ise bu Array'ler "Multidimensional Array" dir.INTERVIEW!!!
    ...
    public static void main(String[] args) {
        ...
        //Multidimensional Array consol'a nasil yazdirilir?
        ...
        //Example 1:Bir String Multidimensional Array olusturunuz.
        ...
        System.out.println(Arrays.deepToString(brr));//[[A, B, C], [D, E, F], [F, H, I], [J, K, L]]

        //          Toplam eleman sayisini ekrana yazdiran kodu yaziniz
        int sum=0;

        for(String[] w:brr){//data tipi string array
